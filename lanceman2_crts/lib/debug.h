/** This file provides some CPP macro debug functions:
 *
 ...
 *
 *
 * It's really not much but is a powerful development
 * tool like assert.  See 'man assert'.
 *
 *
 * This debug.h/debug.c code is not intended to be part of the user
 * interface.
 */
#include <stdbool.h>
#include <errno.h>
...
#ifndef SPEW_FILE
#  error "SPEW_FILE must be defined consistently"
#endif
