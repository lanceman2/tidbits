...
/* got this from:
  ...
  http://www.gnutls.org/manual/html_node/Echo-server-with-X_002e509-authentication.html
...
/******************************************************************
 *  To generate files: key.pem, cert.pem, crl.pem
 *  run:

rm -f key.pem cert.pem crl.pem
...
#define MAX_BUF 1024
#define PORT 4442     /* listen to port */
...
int main(void)
{
        ...
        for (;;) {
                ...
                gnutls_alpn_set_protocols(session, protocols,
                        1/*num procols*/, 0/*flags*/);
