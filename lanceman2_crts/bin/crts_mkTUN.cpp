/*
   We need to run this as effective user 'root' so we need to run
   something like:
...
//
// TODO: add a private key and public key pair that is generated when this
// is installed in order to stop other programs from running this program
// and making lots of TUN devices and sub-networks.  Ya, how does that
// work??
//
// The user API int ../lib/getTunViaUSocket.cpp sends a magic number
// and than reads TUN fd.
// Ya, something...
...
static int usage(const char *argv0)
{
    ...
    fprintf(SPEW_FILE,
        ...
        "  file descriptor 1 is the UNIX domain socket.  File descriptor 1 is a tty device and\n"
        "  therefore not a UNIX domain socket.  You can use the code in getTunViaUSocket.cpp to\n"
        "run and connect to this program to get a TUN file descriptor.\n\n");
    return 1;
}
